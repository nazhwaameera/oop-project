...
public final class View {
    ...
    public View(int width, int height, int scale, Deque<Point> snakeBody, Point apple, Point orange, Point rottenapple
        ...
        gamePanel = new GamePanel(width, height, scale, snakeBody, apple, orange, rottenapple, difficulty, score, highScore, applesEaten, orangesEaten, rottenApplesEaten, isEatingApple, isEatingOrange, isEatingRottenApple);
    ...
    public void update(String difficulty, int score, int highScore) {
        gameOverPanel.update(difficulty, score, highScore);
    }
